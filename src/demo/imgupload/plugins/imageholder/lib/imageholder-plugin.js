...
define(
	...
	'aloha/plugin', 
	'aloha/floatingmenu', 
	'i18n!imageholder/nls/i18n', 
	'i18n!aloha/nls/i18n', 
	'css!imageholder/css/imageholder.css'],
function (Aloha, jQuery, Plugin, FloatingMenu, i18n, i18nCore) {
	...
	function CharacterOverlay(onSelectCallback) {
		var self = this;
		self.$node = jQuery('<table class="aloha-image-holder-overlay" unselectable="on" role="dialog"><tbody></tbody></table>');
	...
	CharacterOverlay.prototype = {
        ...
        /*
        popupUploadForm: function() {
            var newWindow = window.open('ajaxuploadform.htm', 'name', 'height=480,width=360');
        },
       */
			...
			jQuery('body').click(function (e) {
				var overlayVisibleAndNotTarget
				    ...
				    // don't consider clicks to the 'show' button.
						!jQuery(e.target).is('button.aloha-button-imageholder');
        ...
        /*
        popupUploadForm: function () {
            var newWindow = window.open('/wywhat/demo/upload/ajaxuploadform.htm', 'name', 'height=480,width=360');
        },
       */
        ...
        insertLink: function ( extendToWord ) {
            ...
            /*
            newLink = jQuery( '<a href="" class="aloha-new-link">' + '[XOOM]' + '</a>' );
            GENTICS.Utils.Dom.insertIntoDOM( newLink, range, jQuery( Aloha.activeEditable.obj ) );
            */
            
            newImg = jQuery( '<a href="#" onclick=popupUploadForm()><img src="image-holder.png" /></a>' );
		...
		_createCharacterButtons: function (characters) {
            ...
            /*
            jQuery( '<div id="main-upload"><h31>Upload Your Images</h3>'+
                '<form method="post" enctype="multipart/form-data"  action="upload.php">'+
                '<input type="file" name="images" id="images" multiple />'+
                '<button type="submit" id="btn">Upload Files!</button>' ).appendTo(self.$node);
	...
	return Plugin.create('imageholder', {
		_constructor: function () {
			this._super('imageholder');
		},
		languages: ['en'],
		...
		init: function () {
			...
			self.insertButton = new Aloha.ui.Button({
				'name': 'imageholder',
				'iconClass': 'aloha-button-imageholder',
				'size': 'small',
                /*
                ...
                */
                'onclick': function () { self.characterOverlay.insertLink( false ); },
